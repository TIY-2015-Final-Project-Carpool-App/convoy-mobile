//
//  UpdateChildContactViewController.swift
//  CarPoolProject
//
...
class UpdateChildContactViewController: UIViewController, UIAlertViewDelegate {
    ...
    @IBAction func updateChildContact(sender: AnyObject) {
        ...
        RailsRequest.session().updateChildContactWithCompletion(contact!, completion: { () -> Void in
